  ...
  const startStreaming = async () => {
    try {
      const stream = await navigator.mediaDevices.getUserMedia({ 
        ...
        // Backend only exposes `/ws` for JSON messages; microphone streaming over WebSocket
        // is not supported here. We still initialize local audio to show input levels.
      } catch (error) {
