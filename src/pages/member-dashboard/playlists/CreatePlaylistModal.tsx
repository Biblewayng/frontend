                  ...
                  filteredSermons.map((sermon: Sermon) => (
                    ...
                    >
                      ...
                      <div className="ml-3 flex-1 min-w-0">
                        <div className="text-sm font-medium text-gray-900 truncate">{sermon.title}</div>
                        <div className="text-xs text-gray-500 truncate">Speaker: {sermon.speaker}</div>
                      </div>
                    </div>
                  ))
                ) : (
                  <div className="p-4 text-center text-gray-500 text-sm">
                    {searchQuery ? 'No sermons found matching your search' : 'No sermons available'}
                  </div>
                )}
              </div>
