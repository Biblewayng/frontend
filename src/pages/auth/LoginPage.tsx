...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (user) {
      if (['superadmin', 'admin', 'minister', 'staff'].includes(user.role)) {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block flex-1 relative" style={{
        backgroundImage: `url('https://images.unsplash.com/photo-1438232992991-995b7058bbb3?w=1200&h=1600&fit=crop')`,
